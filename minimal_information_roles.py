...
def create_policy_for_role(
    ...
    """
    Crea la política mínima para un rol del ecosistema.

    La política siempre mantiene la regla general:
        "Usuario SUBE Prioridad"

    sin exponer causa ni datos sensibles.
    """
...
def create_demo_information_disclosure_request(
    ...
    return InformationDisclosureRequest(
        ...
        user_consented_station_operational_hint=(
            user_consented_station_operational_hint
        ),
